...
from ..models.suivi_models import EngagementIndicateurSousAspect,SuiviSousAspect,SuiviIndicateurSousAspect,EngagementSousAspect,EngagementAspect, Suivi ,EngagementIndicateur,SuiviIndicateur,EngagementSousAspectEauPollution,EngagementIndicateurSousAspectPollution,SuiviIndicateurSousAspectPollution,SuiviSousAspectPollution
from ..serializers.suivi_serializers import EngagementIndicateurSousAspectSerializer, SuiviIndicateurSousAspectSerializer,SuiviSousAspectSerializer,EngagementSousAspectSerializer,EngagementAspectSerializer, SuiviSerializer ,EngagementIndicateurSerializer,SuiviIndicateurSerializer,EngagementSousAspectEauPollutionSerializer,EngagementIndicateurSousAspectPollutionSerializer,SuiviIndicateurSousAspectPollutionSerializer,SuiviSousAspectPollutionSerializer
...
class EngagementIndicateurSousAspectPollutionCreateView(generics.CreateAPIView):  
    permission_classes = [AllowAny]  
    queryset = EngagementIndicateurSousAspectPollution.objects.all()  
    serializer_class = EngagementIndicateurSousAspectPollutionSerializer  
...
class EngagementSousAspectPollutionRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):  
    permission_classes = [AllowAny]  
    queryset = EngagementSousAspectEauPollution.objects.all()  
    serializer_class = EngagementSousAspectEauPollutionSerializer  
...
class SuiviSousAspectPollutionListCreateView(generics.ListCreateAPIView):
    permission_classes = [AllowAny]
    queryset = SuiviSousAspectPollution.objects.all()
    serializer_class = SuiviSousAspectPollutionSerializer
    ...
    def post(self, request, *args, **kwargs):
        ...
        # Vérification de tous les indicateurs attendus
        engagement_indicateurs_attendus = EngagementIndicateurSousAspectPollution.objects.filter(
        ...
        if serializer.is_valid():
            ...
            for indicateur_data in suivi_indicateurs_data:
                SuiviIndicateurSousAspectPollution.objects.create(
...
class SuiviSousAspectPollutionRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = [AllowAny]
    queryset = SuiviSousAspectPollution.objects.all()
    serializer_class = SuiviSousAspectPollutionSerializer
...
class SuiviIndicateurSousAspectPollutionRetrieveUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    permission_classes = [AllowAny]
    queryset = SuiviIndicateurSousAspectPollution.objects.all()
    serializer_class = SuiviIndicateurSousAspectPollutionSerializer
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return super().destroy(request, *args, **kwargs)
    #--------------------------------------------
class EngagementSousAspectCreateView(generics.CreateAPIView):
    permission_classes = [AllowAny]
    queryset = EngagementSousAspect.objects.all()
    serializer_class = EngagementSousAspectSerializer
