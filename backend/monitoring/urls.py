...
urlpatterns = [
    ...
    path('engagement/', views.EngagementIndicateurListCreateView.as_view(), name='engagement-list-create'),
    path('engagement/<int:pk>/', views.EngagementIndicateurRetrieveUpdateDeleteView.as_view(), name='engagement-detail'),
