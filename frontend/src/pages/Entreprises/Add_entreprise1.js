...
function Add_entreprise1() {  
  ...
  const [popupPosition, setPopupPosition] = useState(null); // État pour la position de la popup  
      ...
      <div className="newContainer">  
        ...
        <div className="top">  
         ...
         {/* <div>  
          ...
          {selectedParcelleId && (  
              <button onClick={() => navigate('/ajouter_entreprise2', { state: { id_parcelle: selectedParcelleId } })}>  
                Next  
              </button>  
          )}  
        </div>  
